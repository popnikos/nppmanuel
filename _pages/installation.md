...
![Le choix du langage lors de l'installation de Notepad++](https://github.com/nliautaud/nppmanuel/blob/master/images/installation/01_language.png)

Choisir la langue qui vous convient pour afficher l'écran d’accueil de l'installateur.

### Une licence libre

![Le choix de la licence lors de l'installation de Notepad++](https://github.com/nliautaud/nppmanuel/blob/master/images/installation/03_licence.png)
...
![Le choix du dossier d'installation lors de l'installation de Notepad++](https://github.com/nliautaud/nppmanuel/blob/master/images/installation/04_directory.png)
...
![Le choix du dossier d'installation lors de l'installation de Notepad++](https://github.com/nliautaud/nppmanuel/blob/master/images/installation/05_components.png)
...
![Le choix des options lors de l'installation de Notepad++](https://github.com/nliautaud/nppmanuel/blob/master/images/installation/06_options.png)
...
![L'écran de chargement de l'installation de Notepad++](https://github.com/nliautaud/nppmanuel/blob/master/images/installation/07_loading.png)
![L'écran de fin de l'installation de Notepad++](https://github.com/nliautaud/nppmanuel/blob/master/images/installation/08_end.png)
