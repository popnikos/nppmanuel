...
![Panneau principal de NppFTP](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/panel_ftp.png)

Il peut être affiché :

- Par le menu *Compléments -> NppFTP -> Show NppFTP Window*,
- Par l'icône ![Icône de NppFTP](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/icon_nppftp.png) située à droite de la barre d'icônes.
...
- ![Icône de (Dis)Connect](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/icon_connect.png) `(Dis)Connect` permet de se connecter à l'un des profils de connexion listés ou de se déconnecter du profil actuel.
- ![Icône de Download file](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/icon_download.png) `Download file` télécharge et ouvre le fichier distant sélectionné. *Cette option n'est disponible qu'une fois connecté et un fichier distant sélectionné.*
- ![Icône de Upload file](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/icon_upload.png) `Upload file` envoie le fichier ouvert dans le dossier distant sélectionné. *Cette option n'est disponible qu'une fois connecté.*
- ![Icône de Refresh](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/icon_refresh.png) `Refresh` réactualise le dossier distant sélectionné. *Cette option n'est disponible qu'une fois connecté et un dossier distant sélectionné.*
- ![Icône de Abort](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/icon_abort.png) `Abort` annule l'opération en cours. *Cette option n'est disponible que lorsqu'une opération est en cours.*
- ![Icône de Settings](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/icon_settings.png) `Settings` : *General settings* ouvre la fenêtre des options générales et *Profile settings* ouvre la fenêtre de gestion des profils de connexion.
- ![Icône de Show message window](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/icon_messageswin.png) `Show messages window` affiche ou cache le panneau des messages.
...
![Panneau des messages de NppFTP](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/panel_messages.png)
...
![Fenêtre d'options générales de NppFTP](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/win_settings.png)
...
![Fenêtre de gestion des profils de connexion de NppFTP](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/win_profiles.png)
...
![Paramètres de connection de NppFTP](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/win_profiles_connection.png)
...
![Paramètres de transferts de NppFTP](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/win_profiles_transfers.png)
...
![Paramètres des commandes FTP de NppFTP](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/win_profiles_misc.png)
...
![Paramètres de cache de NppFTP](https://github.com/nliautaud/nppmanuel/blob/master/images/plugins/nppftp/win_profiles_cache.png)
